import os
from Productos.Nodo import Nodo
...
class ListaDobleCircular:
    ...
    def mostrarProducto(self):
        ...
        while contador < self.tamanio:
            print(str(actual.dato.id) + ' - ' + str(actual.dato.nombre) + ' - ' + str(actual.dato.precio) + ' - ' + str(actual.dato.cantidad) + ' - ' + str(actual.dato.categoria) )
    ...
    def obtenerDato (self, dato):
        ...
        return None
          ...
          # OBTENER EL nombre DE UN NODO
    def obtenerNombre (self, dato):
        actual = self.primero
        contador = 0
        while contador < self.tamanio:
