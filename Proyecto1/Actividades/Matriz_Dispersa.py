...
from Actividades.Nodo_Cabecera import NodoCabecera
from Actividades.Nodo_Celda import NodoCelda
...
class MatrizDispersa:
    ...
    def recorridoColumnas(self, columna):
        ...
        if inicio != None:
            ...
            actual = inicio.acceso
            while actual != None:
                texto_actividades += str(actual.dato) + '\n'
                actual = actual.abajo
        return texto_actividades
            # print(f'{str(actual.x)}, {str(actual.y)} = {str(actual.dato)}')
            # print('-----------------------------------------------')
            # actual = actual.abajo
